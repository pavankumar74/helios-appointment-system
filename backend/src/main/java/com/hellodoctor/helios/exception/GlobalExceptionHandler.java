...
/**
 * Central error handling. Responses use a consistent {@link ApiError} shape and never leak
 * stack traces or sensitive internal details (see PRD section 8 - Error Handling).
 */
